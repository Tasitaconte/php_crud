...
//eyersoftBlan
/*
var var_global_almacen='';

function mialmacen(idal){
	var_global_almacen=idal;
}
...
*/
var Global_Nivel_academico = '';
var Glonal_lista_del_autores = '';
var Global_Autores = '';
var Global_Id_Anexo = '';

var Global_id_documento = '';
var Global_id_autor = '';
var Global_Cod_Barra = '';

var Global_id_persona = '';
...
function LoadSelect2Script(callback) {
    if (!$.fn.select2) {
        $.getScript('./js/lib/plugins/select2/select2.min.js', callback);
    } else {
        if (callback && typeof(callback) === "function") {
            callback();
        }
...
function LoadDataTablesScripts(callback) {
    function LoadDatatables() {
        $.getScript('./js/lib/plugins/datatables/jquery.dataTables.js', function() {
            $.getScript('./js/lib/plugins/datatables/ZeroClipboard.js', function() {
                $.getScript('./js/lib/plugins/datatables/TableTools.js', function() {
                    $.getScript('./js/lib/plugins/datatables/dataTables.bootstrap.js', callback);
                });
            });
        });
    }
...
function TestTable2(idtable) {
    ...
    var header_inputs = $("#" + idtable + " thead input");
